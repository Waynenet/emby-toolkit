...
from .media import task_role_translation, task_populate_metadata_cache, task_sync_ratings_to_emby, task_execute_auto_tagging_rules, task_scan_monitor_folders, task_restore_local_cache_from_db, task_backup_mediainfo, task_build_mediainfo_fingerprints
...
def get_task_registry(context: str = 'all'):
    ...
    full_registry = {
        ...
        'build-mediainfo-fingerprints': (task_build_mediainfo_fingerprints, "提取媒体信息指纹", 'media', True),
